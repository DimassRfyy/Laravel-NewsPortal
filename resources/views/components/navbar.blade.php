<nav class="fixed top-0 left-0 w-full bg-[#c90000] text-white p-4 shadow-md z-50">
    <div class="container mx-auto flex justify-between items-center">
        <a href="{{ route('home') }}"><img src="assets/images/icons/logo.png" class="object-cover h-10 md:h-12" alt="logo"></a>
    ...
    <div id="mobile-menu"
        ...
        <div class="flex gap-3 mt-3">
            ...
            <a href="{{ route('register') }}"
                class="block bg-black text-white px-4 py-2 rounded-lg mt-2">Register</a>
        </div>
